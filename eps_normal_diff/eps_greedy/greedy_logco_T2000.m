...
% generate the virtual battery energy level
    ...
    if exist('use_fixed_env', 'var') && use_fixed_env && exist('fixed_env_data', 'var')
        distances = fixed_env_data.distances(:, :, t);
        gamma = fixed_env_data.gamma(:, :, t);
    else
